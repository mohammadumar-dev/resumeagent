 ...
 * - All refresh tokens are hashed using Bcrypt before storage
...
public class RefreshTokenService {
    ...
    public void createRefreshToken(User user, String rawToken, HttpServletRequest request) {
        // Hash the token before storage (same as password hashing)
     ...
     * SECURITY NOTE:
     * Uses Bcrypt matching which is intentionally slow
     * This rate-limits token validation attempts
    ...
    public Optional<RefreshToken> validateRefreshToken(String rawToken) {
        ...
        // NOTE: This is intentionally database-heavy for security
        // Bcrypt matching must be done in application layer
