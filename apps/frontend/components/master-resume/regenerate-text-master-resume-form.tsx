...
export function RegenerateMasterResumeFromTextForm() {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            toast.success(
                response.message || "Master resume re-generated from text successfully.",
            );
            ...
            toast.error(
                apiError?.message || "Failed to re-generate master resume from text.",
            );
        } finally {
            setIsLoading(false);
        }
