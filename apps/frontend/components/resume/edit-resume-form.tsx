...
export function EditResumeForm( 
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await resumeApi.edit(resumeId, payload);
      toast.success(response.message || "Resume edited successfully.");
      setForm((prev) => ({
        ...initialState,
        email: user?.email ?? "",
      ...
      toast.error(apiError.message || "Failed to edit resume.");
    } finally {
      setIsLoading(false);
    }
  };
